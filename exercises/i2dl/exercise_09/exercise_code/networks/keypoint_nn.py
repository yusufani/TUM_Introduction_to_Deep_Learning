...
class KeypointModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        self.model = nn.Sequential(
            nn.Conv2d(1, hparams['num_filters'], kernel_size=hparams['kernel_size'], padding=hparams['padding']),
            nn.ELU(),
            nn.MaxPool2d(2, 2, padding=hparams['padding']),
            nn.Dropout2d(p=0.1),

            nn.Conv2d(16, hparams['num_filters'] * 2, kernel_size=hparams['kernel_size'] - 1, padding=hparams['padding']),
            nn.ELU(),
            nn.MaxPool2d(2, 2, padding=hparams['padding']),
            nn.Dropout2d(p=0.2),

            nn.Conv2d(32, hparams['num_filters'] * 4, kernel_size=hparams['kernel_size'] - 2, padding=hparams['padding']),
            nn.ELU(),
            nn.MaxPool2d(2, 2, padding=hparams['padding']),
            nn.Dropout2d(p=0.3),
            ...
            #nn.Conv2d(128, hparams['num_filters'] * 8, kernel_size=hparams['kernel_size'] - 3, padding=hparams['padding']),
            #nn.ELU(),
            #nn.MaxPool2d(2, 2, padding=hparams['padding']),
            #nn.Dropout(p=0.4),
