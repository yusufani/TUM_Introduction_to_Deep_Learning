...
class GaussianNoise:
    """
    Transform class that adds gaussian noise to an image
    """
...
class RandomRotate:
    """
    Transform class that rotates an image randomly with a given probability.
    """
    ...
    def __init__(self, prob=0.5, angle=30):
        """
        :param prob: Probability of the image being rotated
